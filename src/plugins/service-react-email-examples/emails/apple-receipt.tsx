...
export class Template extends ReactEmailTemplate {
  public id: string = "apple-receipt";
  public name: string = "Apple Receipt";
  public description: string = "This is a receipt email";
  ...
  Promise<GeneratedMail> {
    ...
    return await ReactEmailTemplate.render("Purchase Invoice", null, template);
  }
}
